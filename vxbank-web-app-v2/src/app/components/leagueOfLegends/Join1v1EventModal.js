...
const Join1v1EventModal = () => {
  ...
  const closeModal = () => {
    const modal = document.getElementById("join-1v1-modal");
  ...
  useEffect(() => {
    ...
    const closeModalButtons = document.querySelectorAll(
      '[data-modal-hide="join-1v1-modal"]'
    );
  ...
  return (
    ...
    tabIndex="-1"
    aria-hidden="true"
    className="hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50"
  >
