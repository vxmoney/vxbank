...
class CurrencyConverterTest {
    ...
    void calculateWith4Decimals() {
        ...
        System.out.println(
                "Crypto Value: " + converter.getCryptoDisplayValue(cryptoValue) + " " + converter.cryptoCurrency);
...

        {
            ...
            System.out.println("Target Fiat Value: " + converter.getFiatDisplayValue(targetFiatValue) + " " +
                    converter.fiatCurrency);
            System.out.println("Required Crypto Value: " + converter.getCryptoDisplayValue(requiredCryptoValue) + " " +
                    converter.cryptoCurrency);
        }
    ...
    @Test
    void calculateWith2Decimals() throws JsonProcessingException {
        // Conversion rate from USDT to EUR (1 USDT = 0.9100 EUR, represented as 9100 with 4 decimals)
        ...
        String jsonConverter = mapper.writeValueAsString(converter);
