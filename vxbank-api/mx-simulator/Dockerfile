...
# ARG for external repository URL and branch/tag
ARG SIMULATOR_REPO_URL
ARG SIMULATOR_REPO_BRANCH

# Clone the external repository
RUN git clone --branch ${SIMULATOR_REPO_BRANCH} ${SIMULATOR_REPO_URL} .
